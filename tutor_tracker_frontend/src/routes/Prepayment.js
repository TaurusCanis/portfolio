...
export default function Prepayment() {
    ...
    useEffect(() => {
        if (authTokens) {
            fetch(`${BASE_URL}prepayments/${params.prepaymentId}/`, {
                method: "GET",
                headers: {
        ...
        <div className="container-v">
            ...
            <div className="model-display">
                ...
                <div className="container-h list-row">
                    <CrudButton path={`/prepayments/${payment.id}/edit`} label="Edit Payment" />
                    <CrudButton path={`/prepayments/${payment.id}/delete`} label="Delete Payment" />
                </div>
            </div>
        </div>
        }
