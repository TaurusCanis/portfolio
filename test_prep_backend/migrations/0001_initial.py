    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('time_limits', models.JSONField(blank=True, null=True)),
            ],
        ),
        migrations.CreateModel(
            name='TestPrepInstructorUser',
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('total_incorrect', models.IntegerField(blank=True, null=True)),
                ('total_omitted', models.IntegerField(blank=True, null=True)),
                ('student_test_attempt', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='student_test_responses', to='test_prep_backend.studenttestattempt')),
            ],
        ),
        migrations.AddField(
